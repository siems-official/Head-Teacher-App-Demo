import { ArrowDownIcon, CheckLineIcon, cn } from "@/services";
...
const SelectScrollUpButton = ({ className, ...props }) => {
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <ArrowDownIcon size={14} className="text-foreground -rotate-90" />
    </SelectPrimitive.ScrollUpButton>
  );
};
...
const SelectScrollDownButton = ({ className, ...props }) => {
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <ArrowDownIcon size={14} className="text-foreground" />
    </SelectPrimitive.ScrollDownButton>
  );
};
