...
const ApprovedApplicationsStudentsScreen = () => {
  ...
  const renderItem = ({ item, index }) => (
    <View
      className={cn(
        ...
        index === approvedstudentApplications?.data?.length - 1
          ? "border-b-0"
          : "border-b"
      )}
    >
    ...
    <BaseLayout title="Approved Applications">
      <View className="relative flex-1">
        ...
        <DataTable
          ...
          data={approvedstudentApplications?.data}
...
export default ApprovedApplicationsStudentsScreen;
