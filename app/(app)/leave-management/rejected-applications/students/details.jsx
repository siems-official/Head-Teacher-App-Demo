...
const RejectedApplicationsStudentsDetailsScreen = () => {
  ...
  const selectedApplication = rejectedstudentApplications?.data?.find(
    (item) => {
...
export default RejectedApplicationsStudentsDetailsScreen;
