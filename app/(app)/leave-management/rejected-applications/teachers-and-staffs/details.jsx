...
const RejectedApplicationsTeachersDetailsScreen = () => {
  const params = useLocalSearchParams();
  const { rejectedteacherStuffApplications } = useSelector(
    (state) => state.leaveManagement
  );

  const selectedApplication = rejectedteacherStuffApplications?.data?.find(
    (item) => {
...
export default RejectedApplicationsTeachersDetailsScreen;
