...
const PendingApplicationsStudentsScreen = () => {
  ...
  const renderItem = ({ item, index }) => (
    <View
      className={cn(
        ...
        index === pendingStudentApplications?.data?.length - 1
          ? "border-b-0"
          : "border-b"
      )}
      key={item._id}
  ...
  return (
    <BaseLayout title="Pending Applications">
      ...
      <DataTable
        ...
        data={pendingStudentApplications?.data}
...
export default PendingApplicationsStudentsScreen;
