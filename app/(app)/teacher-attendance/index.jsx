  ...
  const navigationData = [
    {
      ...
      path: routes.teacherAttendance.subRoutes.todaysAttendance.path,
    },
    {
      _id: 2,
      title: "Attendance History",
      path: routes.teacherAttendance.subRoutes.attendanceHistory.path,
    },
  ];

  return (
    <BaseLayout title="Teacher Attendance">
      <FlatList
        data={navigationData}
